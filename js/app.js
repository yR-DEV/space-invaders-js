...
//  2  |  3
//     |
// By dividing the space into quadrants collision checks
// are reduced to 100 per canvas frame from 5,000
...
function QuadTree(boundBox, lvl) {
	...
	// Getting all of the objects in quadTree
	...
	// Return all objects that obj can collide with
	...
	// Insert the object into the quadTree. If the tree excedes the capacity
	// it will split and add all objects to their nodes.
	this.insert = function(obj) {
		...
		// Prevent the infinite splitting of objects
	...
	// Checks which node the object belongs to. -1 indicates that
	// object cant completely fit within a node and is apart of current node
	this.getIndex = function(obj) {
		...
		// Object can totally fit in top quad
		var topQuadrant = (obj.y < horizontalMidpoint && obj.y + obj.height < horizontalMidpoint);
		// Object can fit completely within the bottom quad
		var bottomQuadrant = (obj.y > horizontalMidpoint);

		// Object can totally fit within the left quadrants
